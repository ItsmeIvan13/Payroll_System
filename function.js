  ...
  function getmyJob(){
    ...
    if(SeniorProg.checked == true){
        ...
        //output
        Myinfo.innerHTML = "<br><br>" + Firstname.value + " " + Middlename.value + " " + Lastname.value + "<br> Your Job is: " + SeniorProg.value +"<br><br> ----- DEDUCTION ----- <br> SSS: 5%<br> Pag ibig: 5%<br> Philhealth: 100 <br> -------------------- <br> Total Salary: "+  total.toFixed(0) + " " + "PHP";
    }
    ...
    Myinfo.innerHTML = "<br><br>" + Firstname.value + " " + Middlename.value + " " + Lastname.value + "<br> Your Job is: " + JuniorProg.value +"<br><br> ----- DEDUCTION ----- <br> SSS: 5%<br> Pag ibig: 5%<br> Philhealth: 100 <br> -------------------- <br> Total Salary: "+  total.toFixed(0) + " " + "PHP";
    }
        ...
        Myinfo.innerHTML = "<br><br>" + Firstname.value + " " + Middlename.value + " " + Lastname.value + "<br> Your Job is: " + WebDesigner.value +"<br><br> ----- DEDUCTION ----- <br> SSS: 5%<br> Pag ibig: 5%<br> Philhealth: 100 <br> -------------------- <br> Total Salary: "+  total.toFixed(0) + " " + "PHP";
    }
        ...
        Myinfo.innerHTML = "<br><br>" + Firstname.value + " " + Middlename.value + " " + Lastname.value + "<br> Your Job is: " + DataAnalyst.value +"<br><br> ----- DEDUCTION ----- <br> SSS: 5%<br> Pag ibig: 5%<br> Philhealth: 100 <br> -------------------- <br> Total Salary: "+  total.toFixed(0) + " " + "PHP";
    }
        ...
        Myinfo.innerHTML = "<br><br>" + Firstname.value + " " + Middlename.value + " " + Lastname.value + "<br> Your Job is: " + ProjectManager.value +"<br><br> ----- DEDUCTION ----- <br> SSS: 5%<br> Pag ibig: 5%<br> Philhealth: 100 <br> -------------------- <br> Total Salary: "+  total.toFixed(0) + " " + "PHP";
